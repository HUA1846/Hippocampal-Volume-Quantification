...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        #if(image[1] != y_shape or image[2] != z_shape):
#             print("filename: {}, invalid image shape, y_shape: {}, z_shape: {}".format(f, image[1], image[2]))
#             continue
        ...
        # ANSWER: in order to obtain binary label
